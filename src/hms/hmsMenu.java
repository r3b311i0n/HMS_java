...
public class hmsMenu {
    ...
    public Label menuLname;
    public Label menuMname;
    public Label menuFname;
    public Label menuUname;
    public Label menuSpecialty;
    public Label menuNic;
    ...
    void setMenuNic(String nic) {
        menuNic.setText(nic);
    }

    void setMenuSpecialty(String specialty) {
        menuSpecialty.setText(specialty);
    }

    void setMenuUname(String uname) {
        menuUname.setText("Hello " + uname + "!");
    }

    void setMenuLname(String lname) {
        menuLname.setText(lname);
    }

    void setMenuMname(String mname) {
        menuMname.setText(mname);
    }

    void setMenuFname(String fname) {
        menuFname.setText(fname);
    }
